...
PANEL_OPERATIONS           = PanelHeader.invoke %w(ID Estado Propuesta Cliente Ejecutivo Monto_Dolares op_creado op_recibido op_entrega OPFechasDeEntrega)
PANEL_OPERATIONS_VALIDATOR = PanelHeader.invoke %w(ID DangerFlag Estado Propuesta Cliente Creado Entrega_Diseno Entrega_Costos Monto_Dolares Cierre Empresa)
